...
<head>
    ...
    <link href="https://fonts.googleapis.com/css?family=Permanent+Marker" rel="stylesheet" <link
        href="https://fonts.googleapis.com/css?family=Fjalla+One" rel="stylesheet" />
...
<body>
    ...
    <div class="sign">
        <form class="" action="signupback.php" method="post">
            <h1>Sign Up</h1>
            ...
            <input type="password" placeholder="Repeat The Password" name="rpassword" class="txtb" />
            <input type="text" placeholder="Phone Number" name="c_ph" class="txtb" />
            <input type="email" placeholder="Email" name="email" class="txtb" />
            <input type="text" placeholder="Address" name="address" class="txtb" />
            <input type="number" placeholder="Travel Experience" name="experience" class="txtb" />

            <input type="submit" value="Sign Up" class="sign-btn" />
            <a href="signin1.php">Already Have one ?</a>
        </form>
    </div>
</body>
